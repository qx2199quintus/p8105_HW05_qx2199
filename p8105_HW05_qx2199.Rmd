...
_Q3.2.1Is the sample average of μ hat  across tests for which the null is rejected approximately equal to the true value of μ? Why or why not?_
...
* Specifically,when true value of mean = 1,2,3, under this scenario, power is relatively increasing but not high enough. Samples on the left of the distribution (smaller means) will not reject the null while most of the samples which is larger than estimated mean will reject the null hypothesis, the average estimated mean will be higher than the true mean value.